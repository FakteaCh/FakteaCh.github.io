...
<h2 class='style8' align=center>Subject List</h2>";
  ...
  <tr>
    ...
    <td width="93%" valign="bottom" bordercolor="#0000FF"> <a href="bmis.php" class="style4"> Management Information System</a></td>
    
  </tr>
  <tr>
    <td height="70" valign="bottom"><img src="image/books-pencil-icon-clipart-117.JPG" width="43" height="43" align="absmiddle"></td>
    <td valign="bottom"> <a href="boop.php" class="style4">Object Oriented Programming </a></td>
  </tr><tr>
    ...
    <td height="70" valign="bottom"><img src="image/books-pencil-icon-clipart-117.JPG" width="43" height="43" align="absmiddle"></td>
    <td valign="bottom"> <a href="bnet.php" class="style4">Computer Networking </a></td>
  </tr><tr>
    <td height="70" valign="bottom"><img src="image/book.JPG" width="43" height="43" align="absmiddle"></td>
    <td valign="bottom"> <a href="bsoft.php" class="style4">Software Engineering</a></td>
  </tr>
  <tr>
    <td height="70" valign="bottom"><img src="image/books-pencil-icon-clipart-117.JPG" width="43" height="43" align="absmiddle"></td>
    <td valign="bottom"> <a href="bunix.php" class="style4">Unix</a></td>
  </tr>
</table>
</div>
<div class="footer">
